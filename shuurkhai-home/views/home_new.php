    ...
    <nav id="navbar" class="fixed left-0 right-0 z-50 transition-all duration-300 bg-transparent navbar-translate" style="top: 0;">
        <div class="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            <div class="flex items-center justify-between" style="height: 70px; padding-top: 25px;">
                ...
                <!-- Logo -->
                <a href="/" class="flex items-center gap-3 hover:scale-105 transition-transform" style="margin-top: 12px;">
                    <img src="/images/logo.png" alt="Shuurkhai Logo" class="h-11 w-auto object-contain">
                ...
                <div class="hidden lg:flex items-center gap-8" style="margin-top: 12px;">
                    <a href="/" class="flex items-center gap-1 font-medium transition-colors text-slate-700 hover:text-[#1e3a5f]">Нүүр</a>
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 pt-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-2 min-w-[220px]">
                                ...
                                <a href="/login" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-50 transition-colors">
                                    <div class="w-10 h-10 rounded-lg bg-[#1e3a5f]/5 flex items-center justify-center">
                                        <i data-lucide="package" class="w-5 h-5 text-[#1e3a5f]"></i>
                                    </div>
                                    <span class="font-medium text-slate-700">Онлайн захиалга</span>
                                </a>
                                <a href="/shop" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-50 transition-colors">
                                    <div class="w-10 h-10 rounded-lg bg-[#1e3a5f]/5 flex items-center justify-center">
                    ...
                    <a href="/faqs" class="font-medium transition-colors text-slate-700 hover:text-[#1e3a5f]">ТУСЛАМЖ</a>
                    <a href="/contact.php" class="font-medium transition-colors text-slate-700 hover:text-[#1e3a5f]">Холбоо барих</a>
                </div>

                <!-- CTA Buttons -->
                <div class="hidden lg:flex items-center gap-4" style="margin-top: 12px;">
                    <a href="/login" class="px-4 py-2 rounded-xl text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-2" title="Нэвтрэх">
                        <i data-lucide="user" class="w-4 h-4"></i>
                        Нэвтрэх
                    </a>
                    <a href="/calculator" class="px-4 py-2 rounded-xl text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-2">
                        <i data-lucide="calculator" class="w-4 h-4"></i>
                        Үнэ тооцоолох
                    </a>
                    <a href="/user/login" class="bg-slate-900 hover:bg-slate-800 text-white px-6 py-2 rounded-xl shadow-sm transition-colors inline-block">
                        Захиалах
                    </a>
                </div>
    ...
    <div id="mobileMenu" class="fixed inset-x-0 z-40 lg:hidden hidden" style="top: 70px;">
        <div class="bg-white/95 backdrop-blur-xl border-t border-slate-100 shadow-xl">
            <div class="max-w-7xl mx-auto px-4 py-6">
                <div class="space-y-2">
                    <a href="/" class="block px-4 py-3 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">Нүүр</a>
                    <div class="ml-4 mt-1 space-y-1">
                        ...
                        <a href="/shop" class="flex items-center gap-3 px-4 py-2 rounded-lg text-slate-600 hover:bg-slate-50 transition-colors">
                            <i data-lucide="store" class="w-4 h-4 text-[#1e3a5f]"></i>
                            Бүх дэлгүүр
                        </a>
                    </div>
                    <a href="/faqs" class="block px-4 py-3 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">ТУСЛАМЖ</a>
                    <a href="/contact.php" class="block px-4 py-3 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">Холбоо барих</a>
                </div>
                <div class="mt-6 pt-6 border-t border-slate-100 space-y-3">
                    ...
                    <a href="/login" class="block w-full text-center px-4 py-2 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors" title="Нэвтрэх">
                        <i data-lucide="user" class="w-4 h-4 inline mr-2"></i>
                        Нэвтрэх
                    </a>
                    <a href="/calculator" class="block w-full text-center px-4 py-2 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors">
                        <i data-lucide="calculator" class="w-4 h-4 inline mr-2"></i>
                        Үнэ тооцоолох
                    </a>
                    <a href="/user/login" class="w-full bg-gradient-to-r from-[#1e3a5f] to-[#2d5a8f] text-white rounded-xl py-2 inline-block text-center">
                        Захиалах
                    </a>
                </div>
            </div>
    ...
    <section class="py-4 sm:py-6 md:py-8 bg-gradient-to-b from-white via-slate-50 to-white relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
            ...
            <div class="flex items-center justify-between mb-4 sm:mb-6">
                ...
                ?>
                <?php if ($is_admin): ?>
                <a href="/admin/shops.php" class="text-slate-700 hover:text-slate-900 font-semibold text-sm group flex items-center gap-1" title="Админ дээрх дэлгүүрүүдийг засварлах">
                    Бүгдийг харах
                    <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                </a>
                <?php else: ?>
                <a href="/shop" class="text-slate-700 hover:text-slate-900 font-semibold text-sm group flex items-center gap-1">
                    Бүгдийг харах
                    <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                </a>
                <?php endif; ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center mb-10">
                        ...
                        $is_admin_cta_section = isset($_SESSION['logged']) && $_SESSION['logged'] === true && 
                                               (isset($_SESSION['customer_id']) && $_SESSION['customer_id'] == 0 || 
                                                (isset($_SESSION['name']) && !empty($_SESSION['name'])));
                        ?>
                        <a href="<?= $is_admin_cta_section ? '/admin/online?action=all' : '/login' ?>" class="bg-gradient-to-r from-slate-900 to-slate-700 text-white hover:from-slate-800 hover:to-slate-600 px-8 py-6 text-base rounded-2xl shadow-lg group transition-all hover:scale-105 inline-block text-center">
                            Бараа захиалах
                            <i data-lucide="arrow-right" class="w-5 h-5 inline ml-2 group-hover:translate-x-1 transition-transform"></i>
                        </a>
                        <a href="/contact.php" class="border-2 border-slate-300 text-slate-700 bg-white/50 backdrop-blur-sm hover:bg-white/70 px-8 py-6 text-base rounded-2xl shadow-md transition-all hover:scale-105 inline-block text-center">
                            Холбогдох
                        </a>
                    </div>
            ...
            <div class="py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
                ...
                <div class="col-span-2 md:col-span-4 lg:col-span-1">
                    <div class="flex items-center gap-3 mb-6">
                        <img src="/images/logo.png" alt="Shuurkhai Logo" class="h-12 w-auto object-contain">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <?php else: ?>
                        <li><a href="/privacy" class="text-slate-400 hover:text-white transition-colors inline-flex items-center gap-1 group">Нууцлалын бодлого <i data-lucide="arrow-up-right" class="w-3 h-3 opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all"></i></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            ...
            <div class="py-6 border-t border-white/10">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <?php else: ?>
                        <a href="/privacy" class="text-sm text-slate-500 hover:text-white transition-colors">Нууцлалын бодлого</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
