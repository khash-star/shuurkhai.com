...
if ($query->num_rows()==1)
{
	...
	{
	echo form_open('agents/container_item_editing');
	echo form_hidden("item_id",$item_id);
	echo "<table class='table table-hover'>";

	echo "<tr><th colspan='2'><h4>Илгээгч</h4></th></tr>";
	echo "<tr><td>Утас:(*)</td><td>".form_input ("sender_contact",customer($sender,"tel"),array("class"=>"form-control","required"=>"required"))."</td></tr>";
	echo "<tr><td colspan='2'><span id='sender_result' class='alert alert-danger small' role='alert'></span></td></tr>";
	echo "<tr><td>Нэр(*)</td><td>".form_input ("sender_name",customer($sender,"name"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Овог</td><td>".form_input ("sender_surname",customer($sender,"surname"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>И-мейл(*)</td><td>".form_input ("sender_email",customer($sender,"email"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Хаяг(*)</td><td>".form_textarea ("sender_address",customer($sender,"address"),array("class"=>"form-control"))."</td></tr>";

	echo "<tr><th colspan='2'><h4>Хүлээн авагч</h4></th></tr>";
	echo "<tr><td>Утас:(*)</td><td>".form_input ("receiver_contact",customer($receiver,"tel"),array("class"=>"form-control","required"=>"required"));
	echo "<span id='receiver_result' class='alert alert-danger' role='alert'></span></td></tr>";
	echo "<tr><td>Нэр(*)</td><td>".form_input ("receiver_name",customer($receiver,"name"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Овог</td><td>".form_input ("receiver_surname",customer($receiver,"surname"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>И-мейл(*)</td><td>".form_input ("receiver_email",customer($receiver,"email"),array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Хаяг(*)</td><td>".form_textarea ("receiver_address",customer($receiver,"address"),array("class"=>"form-control"))."</td></tr>";
	...
	echo "<tr><td>Нийт жин хэмжээ /кг/</td><td>".form_input ("weight",$weight,array("class"=>"form-control","id"=>"weight"))."</td></tr>";
