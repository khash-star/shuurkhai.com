<div class="panel panel-primary">
  <div class="panel-heading">Илгээмжийн төлөв өөрчилөх хэсэг</div>
...
$query = $this->db->query("SELECT orders.*,orders.status AS order_status,customer.*,customer.tel AS contact FROM orders LEFT JOIN customer ON orders.receiver=customer.customer_id WHERE order_id='".$order_id."' AND agents='".$this->session->userdata("agent_id")."'");
