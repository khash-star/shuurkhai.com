...
<div class="panel panel-primary">
  <div class="panel-heading">Илгээмжийн дэлгэрэнгүй мэдээлэл</div>
  <div class="panel-body">
<? 
$query = $this->db->query("SELECT * FROM orders WHERE order_id=".$order_id." AND agents='".$this->session->userdata("agent_id")."' AND is_online='0'");
