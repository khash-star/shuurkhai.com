...
$(document).ready(function() {
	$("span#deliver_button").click(function(){
	$( "#dialog-confirm" ).dialog({
		...
		buttons: 
		{
			...
			"Тийм": function() {
			$( this ).dialog( "close" );
			window.location="<?=base_url()?>/index.php/orders/delivering/<?=$order_id?>";
			}
		}
	});
	});
...
<div id="dialog-confirm" title="Илгээмж хүргэлт" style="display:none;">
<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Энэ захиалгыг эзэнд нь хүргэсэн үү?</p>
</div>
...
if ($query->num_rows() == 1)
{
   $row = $query->row();
    ...
    echo "<span id='deliver_button'>Хүргэж өгөх</a><br>";
   }
