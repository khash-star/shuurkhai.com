...
<script>
jQuery(function($){
		$("input[name='receiver_rd']").mask("өө99999999");
   		$("input[name='receiver_contact']").mask("99999999");
		$("input[name='receiver_name']").mask("bb?bbbbbbbbbbbbbbbbbbbbbbb");
		$("input[name='receiver_surname']").mask("bb?bbbbbbbbbbbbbbbbbbbbbbb");
