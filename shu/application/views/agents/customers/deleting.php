...
<div class="panel panel-success">
  <div class="panel-heading">Хэрэглэгчийн мэдээлэл устгах</div>
...
if ($query->num_rows() == 1)
{
	...
	echo "</table>";
		...
		echo '<div class="alert alert-danger" role="alert">Амжилттай устгалаа</div>';
		else '<div class="alert alert-danger" role="alert">Error:'.$this->db->error.'</div>';

}
else echo '<div class="alert alert-danger" role="alert">Үйлчлүүлэгч олдсонгүй</div>';
