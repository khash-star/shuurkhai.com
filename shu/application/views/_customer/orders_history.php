<div class="panel panel-default">
  <div class="panel-heading">Илгээмжийн түүх (хүлээн авагчаар)</div>
  <div class="panel-body">
<? 
$customer_id = $this->session->userdata('customer_id');
$query = $this->db->query("SELECT * FROM orders WHERE receiver=".$customer_id." AND status IN ('delivered','custom') AND created_date>'2015-09-01' ORDER BY created_date DESC");

if ($query->num_rows() > 0)
{
	echo "<table class='table table-hover'>";
	echo "<tr><th>№</th><th width='90'>Огноо</th><th>Barcode</th><th>Track</th><th>Жин</th><th>Үйлдэл</th></tr>";
	$i=$query->num_rows();
	...
	echo "<tr>";
	echo "<td>".$i--."</td>";
	echo "<td>".substr($delivered_date,0,10)."</td>";
