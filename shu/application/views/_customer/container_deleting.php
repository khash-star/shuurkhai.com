...
if ($query->num_rows() == 1)
	{
		...
		echo '<div class="alert alert-danger" role="alert">Таны ачаа биш байна.</div>';
	}
	else //$row->status=="weight_missing"
	echo '<div class="alert alert-danger" role="alert">Ачаа манайх салбарт ирсэн учираас устгах боломжгүй.</div>';
	}
...
<?=anchor("customer/container","Чингэлэгийн ачаа",array("class"=>"btn btn-success"));?>
