...
if ($this->uri->segment(3)) 
	...
	$sql = "SELECT * FROM envoice WHERE customer_id=".$customer_id." AND envoice_id='$envoice_id'";
...
<?
	...
	echo "<tr><td colspan='3' align='right'>Нийт төлбөр(₮) үүсгэсэн өдрийн ханшаар</td><td>".$amount."</td></tr>";
