...
<? 
echo form_open("customer/online_creating");
	...
	echo "<tr><td>Линк</td><td>".form_textarea("url","",array("class"=>"form-control","placeholder"=>"Талбарт нэг линк оруулна уу"))."</td></tr>";	

	echo "<tr><td>Тоо</td><td>".form_input("number","",array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Хэмжээ</td><td>".form_input("size","",array("class"=>"form-control"))."</td></tr>";
	echo "<tr><td>Өнгө</td><td>".form_input("color","",array("class"=>"form-control"))."</td></tr>";
