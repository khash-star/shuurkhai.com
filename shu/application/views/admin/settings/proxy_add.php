...
<div class="panel panel-primary">
  <div class="panel-heading">Public Proxy нэмэх</div>
  <div class="panel-body">
<? 
echo form_open('admin/proxy_adding');
echo "<table class='table table-hover'>";
echo "<tr><td>Нэр:(*)</td><td>".form_input ("proxy_name","",array("class"=>"form-control","required"=>"true"))."</td></tr>";
echo "<tr><td>Овог:</td><td>".form_input ("proxy_surname","",array("class"=>"form-control"))."</td></tr>";
echo "<tr><td>Утас:(*)</td><td>".form_input ("proxy_contacts","",array("class"=>"form-control","required"=>"true"))."</td></tr>";
