...
if (isset($_POST["start_date"])) $start_date =$_POST["start_date"]; else $start_date=$start_date = date('Y-m-d', strtotime(date('Y-m-d') . ' -7 days'));
...
<div class="panel panel-primary">
  ...
  <? echo form_open("admin/delivered");?>
...
?>
<? echo form_dropdown("method_type",$options,'all',array("class"=>"form-control"));?>
