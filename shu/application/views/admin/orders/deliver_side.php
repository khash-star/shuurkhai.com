...
<!--li  class="list-group-item"><? //anchor('orders/create', 'Илгээмж оруулах')?></li-->
    <li class="list-group-item"><?=anchor('admin/barcode', 'Barcode')?></li>
    <li class="list-group-item"><?=anchor('admin/barcode_insert', 'Barcode оруулах')?></li>
    <li class="list-group-item"><?=anchor('admin/online', 'Online захиалгууд')?></li>
<!--li   class="list-group-item"><? //=anchor(base_url().'assets/orders.xlsx', 'Excel файл татах')?></li>
</ul>
</ul>
  </div>
</div>