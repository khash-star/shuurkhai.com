...
$query = $this->db->query("SELECT * FROM online_orders WHERE order_id='".$search."'");
if ($query->num_rows() == 0) 
$query = $this->db->query("SELECT * FROM online_orders WHERE barcode='".$search."'");
if ($query->num_rows() == 0) 
$query = $this->db->query("SELECT * FROM online_orders WHERE third_party='".$search."'");
if ($query->num_rows() == 1)
{
   		$row = $query->row();
