...
if (isset($_POST["barcodes"]))
	...
	$barcode_first=$barcode_array[0]; //Эхний баркодын эзэн
		
	$sql = "SELECT * FROM orders WHERE barcode='".$barcode_first."'";
...
<table width="100%">
  <tr><td align="left" width="50%">Нэхэмжлэгч:<br />Shuurkhai Cargo </td>
    ...
    <td align="left">Төлөгч: <br /> <?=customer($receiver,"full_name");?></td></tr>
    <tr><td align="left" width="50%">Хаяг:<br />4712 OAKTON STREET, Chicago, IL, 60076</td>
  
    
    <td align="left">Хаяг: <br /><?=customer($receiver,"address");?></td></tr>
      
	<tr><td align="left">  Утас:<br />773-621-6807</td><td> Утас:<br /><?=customer($receiver,"tel");?></td></tr>
    <tr><td align="left">  Email:<br />info@shuurkhai.com </td><td> Email:<br /><?=customer($receiver,"email");?></td></tr>
...
<?
	...
	$sql = "SELECT * FROM orders WHERE barcode='".$barcode."'";
	...
	echo "<tr><td colspan='3' align='right'>Нийт төлбөр($)</td><td>".cfg_price($total_weight)."</td></tr>";
	echo "<tr><td colspan='3' align='right'>Нийт төлбөр(₮) үүсгэсэн өдрийн ханшаар</td><td>".number_format(cfg_rate()*cfg_price($total_weight))."</td></tr>";
	echo "</table>";
