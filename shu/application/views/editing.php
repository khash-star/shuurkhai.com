...
<? 
	...
	$sql="UPDATE customer SET surname='$surname',rd='$rd',email='$email',address='".$address."',name='".$name."',username='".$username."',password='".$password."' WHERE customer_id=$customer_id LIMIT 1";
