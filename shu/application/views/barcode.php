<?php
require_once(base_url().'assets/class/BCGFontFile.php');
require_once(base_url().'assets/class/BCGDrawing.php');
require_once(base_url().'assets/class/BCGcode128.barcode.php');
