    ...
    if (mysqli_num_rows($result)==1)
        {
            ...
            if ($select =="")
            {
                $sql = "SELECT * FROM container_item WHERE receiver=".$user_id." AND status NOT IN('delivered','completed','custom') ORDER BY id DESC";
                // $sql = "SELECT * FROM container_item ORDER BY id DESC LIMIT 5";
                ...
                while ($data = mysqli_fetch_array($result))
                {
                    ...
                    $order["container_description"] = "9/8-нд гарсан чингэлэг";
