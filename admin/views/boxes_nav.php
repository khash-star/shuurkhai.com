<ul class="navbar-nav aux-nav">
    ...
    if (isset($_GET["id"]))
    {
        ...
        ?>
        <li class="nav-item"><a class="nav-link" href="?action=detail&id=<?=$order_id;?>">Box дэлгэрэнгүй</a></li>
        <li class="nav-item"><a class="nav-link" href="?action=badge&id=<?=$order_id;?>">Box гадуур дагавар</a></li>
        <li class="nav-item"><a class="nav-link" href="?action=delete&id=<?=$order_id;?>">Box Устгах</a></li>
        <?
    }
    ?>
</ul>