<?php
    ...
    if (!isset($g_icon)) {
        $g_icon = "/admin/assets/images/favicon.png";
    }
							...
							<div class="row">
                                ...
                                <div class="col-md-8 pl-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="index" class="noble-ui-logo d-block mb-2"><img src="/admin/assets/images/logo.png"></a>
                                        <form method="post" action="/admin/views/logining.php">
