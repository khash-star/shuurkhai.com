                    ...
                    if (isset($conn) && $conn && isset($sql)) {
                        ...
                        if ($result) {
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                $container_id = isset($data["container"]) ? intval($data["container"]) : 0;
                                $container_name = isset($data["container_name"]) ? htmlspecialchars($data["container_name"]) : '';
                                ...
                                <td>
                                <?php echo !empty($created_date) ? htmlspecialchars(substr($created_date, 0, 10)) : ''; ?>
                                </td>
                                ...
                                <td><?php echo htmlspecialchars($track ?? ''); ?>
                                    <?php 
                                    if ($proxy != 0) {
                                        ?>
                                        <br>
                                ...
                                <td><?php echo htmlspecialchars($container_name ?? ''); ?></td>
                                <td>
                                <?php
                                ...
                                <td>
                                    <a href="packages?action=container_detail&id=<?php echo htmlspecialchars($order_id ?? 0); ?>" class="btn btn-success btn-xs">Дэлгэрэнгүй</a>
                                </td>
                                </tr>
                                <?php
                                if (!empty($weight)) {
